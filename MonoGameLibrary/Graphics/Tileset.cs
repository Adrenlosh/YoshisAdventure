...
public class Tileset
{
    ...
    public Tileset(TextureRegion textureRegion, int tileWidth, int tileHeight, int[] blockingTiles)
    {
        TileWidth = tileWidth;
        ...
        _tiles = new Tile[Count];//new TextureRegion[Count];
        ...
        for (int i = 0; i < Count; i++)
        {
            ...
            _tiles[i] = new Tile(
                ...
                blockingTiles != null && blockingTiles.Contains(i),
                i
            );
        }
    }
