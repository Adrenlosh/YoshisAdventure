...
namespace YoshisAdventure.Screens
{
    public class MapScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.FillRectangle(GameMain.ViewportAdapter.BoundingRectangle, Color.GreenYellow);
            _spriteBatch.FillRectangle(new Rectangle(45, 45, _renderTarget.Width, _renderTarget.Height), Color.Gray);
            ...
            _spriteBatch.DrawString(_bitmapFont, $"{stageName}", new Vector2(25, 10), Color.Black);
            _spriteBatch.DrawString(_bitmapFont, $"x{GameMain.PlayerStatus.LifeLeft}", new Vector2(25, 20), Color.Black);
